...
Loads:
  ...
  - LoRA adapter: backend/local_model_output (from train_local.py)
"""
...
def _build_prompt() -> str:
    ...
    # Match the ChatML-style template used during training, but leave assistant empty.
    return (
        f"<|im_start|>system\n{system}<|im_end|>\n"
        f"<|im_start|>user\n{user}<|im_end|>\n"
        "<|im_start|>assistant\n"
